...
export const MATCHES = [
  // ── OFICIAL 2021/22 ───────────────────────────────────────────────────────────
// Insertar ANTES del bloque de Supercopa Entre Ríos 2023 (order 101).
// Usa orders 1–23 para mantener el orden cronológico ascendente.

  { order:  1, torneo: "Oficial 2021/22",              rival: "Quilmes",     condition: "Local",     score: "6 - 2", date: "19/09/21" },
  { order:  2, torneo: "Oficial 2021/22",              rival: "Urquiza",     condition: "Local",     score: "3 - 0", date: "26/09/21" },
  { order:  3, torneo: "Oficial 2021/22",              rival: "Juventud",    condition: "Visitante", score: "0 - 3", date: "26/09/21" },
  { order:  4, torneo: "Oficial 2021/22",              rival: "El Progreso", condition: "Visitante", score: "0 - 2", date: "10/10/21" },
  { order:  5, torneo: "Oficial 2021/22",              rival: "Bancario",    condition: "Visitante", score: "0 - 0", date: "24/10/21" },
  { order:  6, torneo: "Oficial 2021/22",              rival: "Sociedad Sportiva",    condition: "Local",     score: "3 - 3", date: "31/10/21" },
  { order:  7, torneo: "Oficial 2021/22",              rival: "La Academia", condition: "Visitante", score: "2 - 4", date: "07/11/21" },
  { order:  8, torneo: "Oficial 2021/22",              rival: "Libertad",    condition: "Visitante", score: "1 - 3", date: "28/11/21" },
  { order:  9, torneo: "Oficial 2021/22",              rival: "Gualeguay Central",     condition: "Visitante", score: "2 - 1", date: "05/12/21" },
  { order: 10, torneo: "Oficial 2021/22",              rival: "Quilmes",     condition: "Visitante", score: "1 - 3", date: "12/12/21" },
  { order: 11, torneo: "Oficial 2021/22",              rival: "Urquiza",     condition: "Visitante", score: "1 - 1", date: "30/01/22" },
  { order: 12, torneo: "Oficial 2021/22",              rival: "Juventud",    condition: "Local",     score: "3 - 2", date: "06/02/22" },
  { order: 13, torneo: "Oficial 2021/22",              rival: "El Progreso", condition: "Visitante", score: "0 - 2", date: "13/02/22" },
  { order: 14, torneo: "Oficial 2021/22",              rival: "Bancario",    condition: "Local",     score: "1 - 0", date: "20/02/22" },
  { order: 15, torneo: "Oficial 2021/22",              rival: "Sociedad Sportiva",    condition: "Local",     score: "2 - 1", date: "13/03/22" },
  { order: 16, torneo: "Oficial 2021/22",              rival: "La Academia", condition: "Local",     score: "1 - 0", date: "20/03/22" },
  { order: 17, torneo: "Oficial 2021/22",              rival: "Libertad",    condition: "Visitante", score: "3 - 0", date: "27/03/22" },
  { order: 18, torneo: "Oficial 2021/22",              rival: "Gualeguay Central",     condition: "Local",     score: "0 - 0", date: "10/04/22" },
  { order: 19, torneo: "Oficial 2021/22 · Semifinal", rival: "Sociedad Sportiva",    condition: "Visitante", score: "0 - 0", date: "17/04/22" },
  { order: 20, torneo: "Oficial 2021/22 · Semifinal", rival: "Sociedad Sportiva",    condition: "Local",     score: "1 - 1", date: "24/04/22" },
  { order: 21, torneo: "Oficial 2021/22 · Final",     rival: "Urquiza",     condition: "Local",     score: "3 - 2", date: "01/05/22" },
  { order: 22, torneo: "Oficial 2021/22 · Final",     rival: "Urquiza",     condition: "Visitante", score: "2 - 1", date: "08/05/22" },
  { order: 23, torneo: "Oficial 2021/22 · Final",     rival: "Urquiza",     condition: "Local",     score: "3 - 0", date: "15/05/22" },
  // ── SUPERCOPA ENTRE RÍOS 2023 ─────────────────────────────────────────────
  // ── OFICIAL 2022 ──────────────────────────────────────────────────────────────
  // Insertar DESPUÉS del bloque Oficial 2021/22 (orders 1-23)
  // y ANTES de Supercopa Entre Ríos 2023 (orders 101-110).
  // Usa orders 51-61.

  // Fase de grupos — Zona B (+ interzonales)
  { order: 51, torneo: "Oficial 2022",                  rival: "La Academia",       condition: "Visitante", score: "3 - 3", date: "10/07/22" },
  { order: 52, torneo: "Oficial 2022",                  rival: "Gualeguay Central", condition: "Visitante", score: "1 - 3", date: "17/07/22" },
  { order: 53, torneo: "Oficial 2022",                  rival: "El Progreso",       condition: "Local",     score: "1 - 1", date: "24/07/22" },
  { order: 54, torneo: "Oficial 2022",                  rival: "Libertad",          condition: "Local",     score: "2 - 1", date: "31/07/22" },
  { order: 55, torneo: "Oficial 2022",                  rival: "Quilmes",           condition: "Local",     score: "1 - 0", date: "07/08/22" },

  // Cuartos de Final
  { order: 56, torneo: "Oficial 2022 · Cuartos",       rival: "Sociedad Sportiva", condition: "Visitante", score: "2 - 1", date: "21/08/22" },
  { order: 57, torneo: "Oficial 2022 · Cuartos",       rival: "Sociedad Sportiva", condition: "Local",     score: "2 - 0", date: "28/08/22" },

  // Semifinal
  { order: 58, torneo: "Oficial 2022 · Semifinal",     rival: "Bancario",          condition: "Visitante", score: "1 - 1", date: "04/09/22" },
  { order: 59, torneo: "Oficial 2022 · Semifinal",     rival: "Bancario",          condition: "Local",     score: "2 - 0", date: "11/09/22" },

  // Final
  { order: 60, torneo: "Oficial 2022 · Final",         rival: "Urquiza",           condition: "Visitante", score: "0 - 1", date: "18/09/22" },
  { order: 61, torneo: "Oficial 2022 · Final",         rival: "Urquiza",           condition: "Local",     score: "1 - 0", date: "25/09/22" },
