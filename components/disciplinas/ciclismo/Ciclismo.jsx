...
const ACHIEVEMENTS = [
  {
    title: "1° Puesto Vuelta a Entre Ríos",
    date: "2025",
    imageSrc: "/disciplinas/ciclismo/foto_04.jpg",
    imageAlt: "Milagros Sanabria campeona",
    description:
      "Gran victoria de Milagros Sanabria en la categoría damas, llevando al club a lo más alto de la provincia.",
  },
  {
    title: "Copa Entrerriana de Rural Bike",
    date: "2024",
    imageSrc: "/disciplinas/ciclismo/foto_01.jpg",
    imageAlt: "Equipo de ciclismo CABN",
    description:
      "Destacadas actuaciones en el certamen provincial con podios individuales y por equipos para el Norte.",
  },
];

const GALLERY = [
  { src: "/disciplinas/ciclismo/foto_06.jpg", alt: "Equipo de ciclismo" },
  { src: "/disciplinas/ciclismo/foto_02.jpg", alt: "Pelotón del club" },
  { src: "/disciplinas/ciclismo/foto_03.jpg", alt: "Ciclistas en ruta" },
  { src: "/disciplinas/ciclismo/foto_05.jpg", alt: "Competidores de Barrio Norte" },
  { src: "/disciplinas/ciclismo/foto_07.jpg", alt: "Ciclismo histórico CABN" },
  { src: "/disciplinas/ciclismo/foto_08.jpg", alt: "Ciclistas en carrera" },
];
      ...
      <header className="border-b border-gray-200 bg-white">
        <div className="container mx-auto px-4 pt-8 pb-10 sm:pt-10 sm:pb-12 text-center">
          ...
          <h1 className="text-2xl sm:text-3xl lg:text-4xl font-extrabold text-gray-900">
            Ciclismo en <span className="text-[#B71C1C] italic">Barrio Norte</span>
          </h1>
        </div>
      </header>
      ...
      <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-8 sm:pt-10 space-y-10">
          ...
          <div className="relative z-10 p-6 sm:p-10 lg:p-12 flex flex-col md:flex-row items-start md:items-center justify-between gap-8">
            <div className="max-w-2xl space-y-4">
              <p className="text-xs font-extrabold uppercase tracking-[0.25em] text-red-500">
                RUTA, PISTA Y RURAL BIKE
              </p>

              <h2 className="text-2xl sm:text-4xl font-black text-white leading-tight">
                Pedaleá con los colores del Norte
              </h2>
              <p className="text-sm sm:text-base text-gray-300 leading-relaxed">
                El ciclismo de Barrio Norte representa a la ciudad en los principales certámenes de ruta, fondo y pista, combinando entrenamiento de alto rendimiento con espíritu de equipo.
              </p>
        ...
        <section className="bg-white rounded-2xl border border-gray-200 p-6 sm:p-8 shadow-sm">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 text-sm sm:text-base text-gray-600 leading-relaxed">
            <div className="space-y-3">
              <h3 className="font-bold text-gray-900 text-base">
                Fuerza, Rodaje y Espíritu de Pelotón
              </h3>
              <p>
                El ciclismo en Barrio Norte representa la perseverancia, el esfuerzo silencioso y la resistencia sobre las rutas entrerrianas. Nuestros ciclistas recorren cientos de kilómetros semanales en entrenamientos de fondo, series de velocidad y salidas grupales, promoviendo tanto el acondicionamiento físico como los valores de solidaridad y cuidado mutuo en la ruta.
              </p>
              <p>
                El pelotón norteño es un espacio abierto para ciclistas de diferentes edades y niveles que buscan superarse día a día vistiendo con orgullo la indumentaria oficial del club.
              </p>
            </div>

            <div className="space-y-3">
              <h3 className="font-bold text-gray-900 text-base">
                Competencia Federada, Rutas y Títulos
              </h3>
              <p>
                El equipo de ciclismo del club compite activamente en los certámenes más exigentes del calendario provincial y regional, con podios destacados en pruebas de ruta, crono y Rural Bike, como los resonantes triunfos de Milagros Sanabria en la Vuelta Femenina a Entre Ríos.
              </p>
              <p>
                A través de la subcomisión se coordinan las salidas de fin de semana, el apoyo logístico en carreras intermunicipales y el asesoramiento a quienes desean iniciarse en las modalidades de ruta o pista.
              </p>
            </div>
          </div>
          ...
          <div className="mt-8 grid grid-cols-1 sm:grid-cols-3 gap-4 pt-6 border-t border-gray-100">
            <div className="p-4 rounded-xl bg-gray-50 border border-gray-100">
              <p className="text-xs font-bold text-gray-400 uppercase tracking-wider">Entrenamientos</p>
              <p className="text-sm font-bold text-gray-900 mt-1">Rutas y Acceso Norte</p>
              <p className="text-xs text-gray-500 mt-0.5">Rodajes en pelotón programados</p>
            </div>
            <div className="p-4 rounded-xl bg-gray-50 border border-gray-100">
              <p className="text-xs font-bold text-gray-400 uppercase tracking-wider">Modalidades</p>
              <p className="text-sm font-bold text-gray-900 mt-1">Ruta, Fondo y Rural Bike</p>
              <p className="text-xs text-gray-500 mt-0.5">Pruebas individuales y por equipos</p>
            </div>
            <div className="p-4 rounded-xl bg-gray-50 border border-gray-100">
              <p className="text-xs font-bold text-gray-400 uppercase tracking-wider">Coordinación</p>
              <p className="text-sm font-bold text-gray-900 mt-1">Subcomisión de Ciclismo</p>
              <p className="text-xs text-gray-500 mt-0.5">Contacto vía WhatsApp oficial</p>
            </div>
          </div>
        </section>
        ...
        <section>
          <div className="mb-4">
            ...
            <h2 className="text-2xl font-extrabold text-gray-900">Galería de Ciclismo</h2>
          </div>
