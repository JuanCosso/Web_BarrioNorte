          ...
          <div className="max-w-4xl">
            ...
            {contact ? (
              <div className="mt-6 flex flex-col sm:flex-row sm:items-center gap-3">
                {contact.asociateHref && (
                  <Link href={contact.asociateHref} className="inline-flex items-center justify-center gap-2 rounded-xl px-4 py-2.5 text-sm font-semibold transition focus:outline-none focus:ring-2 focus:ring-white/20 bg-[color:var(--brand)] text-white hover:brightness-110">
                    <IconUsers className="h-5 w-5 shrink-0" />
                    {contact.asociateLabel || "Asociate hoy"}
                  </Link>
                )}
