...
function IconFacebook(props) {
  return (
    <svg viewBox="0 0 24 24" className="w-5 h-5" fill="currentColor" aria-hidden="true" {...props}>
      <path d="M14 8.7V7c0-.7.4-1 1.2-1H17V3h-2.3C12.6 3 11 4.5 11 6.8v1.9H9v3h2V21h3v-9.3h2.4l.6-3H14Z" />
    </svg>
  );
}
...
function IconTrophy(props) {
  return (
    <svg viewBox="0 0 24 24" className="w-5 h-5 text-amber-500" fill="currentColor" aria-hidden="true" {...props}>
...
const ORG = {
  title: "Entrenamientos y Actividades",
  description:
    "Los días y horarios de entrenamiento, niveles (iniciación, formativo y avanzado) y la reserva de canchas se coordinan directamente con la Subcomisión de Tenis. Se trabaja en técnica de golpes, desplazamiento, preparación física y táctica de partido, tanto para singles como dobles en un marco de compañerismo.",
};

const ACHIEVEMENTS = [
  {
    title: "Torneo de Dobles CABN",
    date: "2023",
    imageSrc: "/disciplinas/tenis/img_00.jpg",
    imageAlt: "Tenis Barrio Norte",
    description:
      "Gran convocatoria en el tradicional certamen disputado en las canchas del club, con categorías 'A' y 'B'.",
  },
];

const GALLERY = [
  { src: "/disciplinas/tenis/img_01.jpg", alt: "Tenis Barrio Norte 1" },
  { src: "/disciplinas/tenis/img_02.jpg", alt: "Tenis Barrio Norte 2" },
  { src: "/disciplinas/tenis/img_03.jpg", alt: "Tenis Barrio Norte 3" },
  { src: "/disciplinas/tenis/img_04.jpg", alt: "Tenis Barrio Norte 4" },
  { src: "/disciplinas/tenis/img_05.jpg", alt: "Tenis Barrio Norte 5" },
  { src: "/disciplinas/tenis/img_06.jpg", alt: "Tenis Barrio Norte 6" },
];
      ...
      <header className="border-b border-gray-200 bg-white">
        <div className="container mx-auto px-4 pt-8 pb-10 sm:pt-10 sm:pb-12 text-center">
          ...
          <h1 className="text-2xl sm:text-3xl lg:text-4xl font-extrabold text-gray-900">
            Tenis en <span className="text-[#B71C1C] italic">Barrio Norte</span>
          </h1>
        </div>
      </header>
          ...
          <div className="relative z-10 p-6 sm:p-10 lg:p-12 flex flex-col md:flex-row items-start md:items-center justify-between gap-8">
            <div className="max-w-2xl space-y-4">
              ...
              <h2 className="text-2xl sm:text-4xl font-black text-white leading-tight">
                Sumate a jugar y entrenar en el club
              </h2>
              <p className="text-sm sm:text-base text-gray-300 leading-relaxed">
                Nuestras canchas están a disposición de los socios y deportistas. Consultá disponibilidad de turnos diurnos y nocturnos, clases formativas y torneos de fin de semana.
              </p>
        ...
        <section className="bg-white rounded-2xl border border-gray-200 p-6 sm:p-8 shadow-sm">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 text-sm sm:text-base text-gray-600 leading-relaxed">
            <div className="space-y-3">
              <h3 className="font-bold text-gray-900 text-base">
                Pasión, Técnica y Desarrollo Integral
              </h3>
              <p>
          ...
          <div className="mt-8 grid grid-cols-1 sm:grid-cols-3 gap-4 pt-6 border-t border-gray-100">
            <div className="p-4 rounded-xl bg-gray-50 border border-gray-100">
              <p className="text-xs font-bold text-gray-400 uppercase tracking-wider">Superficie</p>
              <p className="text-sm font-bold text-gray-900 mt-1">Polvo de Ladrillo</p>
              <p className="text-xs text-gray-500 mt-0.5">Iluminación para turnos noche</p>
            </div>
            <div className="p-4 rounded-xl bg-gray-50 border border-gray-100">
              <p className="text-xs font-bold text-gray-400 uppercase tracking-wider">Modalidades</p>
              <p className="text-sm font-bold text-gray-900 mt-1">Singles, Dobles y Escuelita</p>
              <p className="text-xs text-gray-500 mt-0.5">Para todas las edades y niveles</p>
            </div>
            <div className="p-4 rounded-xl bg-gray-50 border border-gray-100">
              <p className="text-xs font-bold text-gray-400 uppercase tracking-wider">Coordinación</p>
              <p className="text-sm font-bold text-gray-900 mt-1">Subcomisión de Tenis</p>
              <p className="text-xs text-gray-500 mt-0.5">Consultas y turnos vía WhatsApp</p>
            </div>
          </div>
        </section>
        ...
        {ACHIEVEMENTS.length > 0 && (
          <section>
            <div className="mb-4">
              ...
              <h2 className="text-2xl font-extrabold text-gray-900">Destacados</h2>
            </div>
        ...
        {GALLERY.length > 0 && (
          <section className="bg-white rounded-2xl border border-gray-200 p-6 sm:p-8 shadow-sm">
            <div className="mb-6">
              ...
              <h2 className="text-2xl font-extrabold text-gray-900">Galería de Imágenes</h2>
            </div>
